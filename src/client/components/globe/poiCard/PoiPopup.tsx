...
const StyledPopUpDiv = styled('div')(({ theme }) => {
  const POP_UP_OUTER_ARROW_WIDTH_EM = theme.popup.marginFromOriginInEm;
  ...
  return {
    ...
    marginLeft: '-13em',
    top: '50%',
    marginTop: `${theme.popup.marginFromOriginInEm}em`,
    ...
    '&::after': {
      ...
      marginLeft: `${calculatePopUpArrowLeftMargin(theme.poiCard.paddingInEm, POP_UP_INNER_ARROW_WIDTH_EM)}em`,
    },
    ...
    '&::before': {
      ...
      marginLeft: `${calculatePopUpArrowLeftMargin(theme.poiCard.paddingInEm, POP_UP_OUTER_ARROW_WIDTH_EM)}em`,
    },
  };
});
