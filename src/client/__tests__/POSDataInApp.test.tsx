...
describe('POS Data in the app', () => {
  ...
  it('should display the "Rewards Distributed" from the hydrated Token store', () => {
  ...
  it('should display the "BlockHeight" from the hydrated Token store', () => {
  ...
  it('should display the "Rewards Clock" from the hydrated Token store', () => {
